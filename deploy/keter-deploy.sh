...
cp .stack-work/install/x86_64-linux/lts-8.5/8.0.2/bin/Ahblog dist/build/Ahblog/Ahblog
...
tar czfv Ahblog.keter dist/build/Ahblog/Ahblog page config static/{css,files,img,fonts,js} .env
